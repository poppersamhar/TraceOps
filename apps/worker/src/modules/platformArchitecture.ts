...
export const TRACEOPS_PRODUCT_RELEASES: TraceOpsProductRelease[] = [
  {
    version: '0.1.0',
    status: 'current',
    title: 'Space Evaluation Collector',
    productAreaIds: ['data_access'],
    scope: '为数据提供同事建设独立的 Space Session 本地采集、完整评测预处理、质量门禁、打包和下载工具。',
    deliverable: 'Evaluation-ready Space Trace Package',
    acceptanceCriteria: [
      '同事可以通过一个主按钮完成 Space Session 收集和整理。',
      '采集器只读本机数据，不自动上传，也不修改 Space 源文件。',
      'thinking、原始路径、原始 Session ID 和已识别敏感字段不会进入数据包，同时保留评测所需结构。',
